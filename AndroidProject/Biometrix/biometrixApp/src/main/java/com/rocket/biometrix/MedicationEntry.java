...
public class MedicationEntry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medication_entry);
    ...
    private void setDatetimeOnPage(){
        TextView textDate = (TextView)findViewById(R.id.MedicationStartDateTextView);
        TextView textTime = (TextView)findViewById(R.id.MedicationStartTimeTextView);
        ...
        textDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog mDatePicker = new DatePickerDialog(MedicationEntry.this, new DatePickerDialog.OnDateSetListener() {
                    public void onDateSet(DatePicker datepicker, int year, int month, int day) {
                        setDate(year, month, day);
                    }
                }, mYear, mMonth, mDay); //mYear, mMonth, and mDay are default values to start the date picker on, which are set to current
        ...
        textTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog time = new TimePickerDialog(MedicationEntry.this, new TimePickerDialog.OnTimeSetListener() {
